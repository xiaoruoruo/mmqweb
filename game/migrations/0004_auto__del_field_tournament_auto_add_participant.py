...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Tournament.auto_add_participant'
        db.delete_column('game_tournament', 'auto_add_participant')


    def backwards(self, orm):
        # Adding field 'Tournament.auto_add_participant'
        db.add_column('game_tournament', 'auto_add_participant',
