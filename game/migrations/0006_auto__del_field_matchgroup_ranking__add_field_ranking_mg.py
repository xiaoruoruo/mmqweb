...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MatchGroup.ranking'
        db.delete_column('game_matchgroup', 'ranking_id')

        # Adding field 'Ranking.mg'
        db.add_column('game_ranking', 'mg',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['game.MatchGroup']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Adding field 'MatchGroup.ranking'
        db.add_column('game_matchgroup', 'ranking',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['game.Ranking'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Ranking.mg'
        db.delete_column('game_ranking', 'mg_id')
