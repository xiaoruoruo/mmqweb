...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PersonalRating.mg'
        db.delete_column('game_personalrating', 'mg_id')

        # Deleting field 'PersonalRating.rating_mixed'
        db.delete_column('game_personalrating', 'rating_mixed')

        # Adding field 'PersonalRating.ranking'
        db.add_column('game_personalrating', 'ranking', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['game.Ranking']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'PersonalRating.mg'
        db.add_column('game_personalrating', 'mg', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['game.MatchGroup']), keep_default=False)

        # Adding field 'PersonalRating.rating_mixed'
        db.add_column('game_personalrating', 'rating_mixed', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)

        # Deleting field 'PersonalRating.ranking'
        db.delete_column('game_personalrating', 'ranking_id')
